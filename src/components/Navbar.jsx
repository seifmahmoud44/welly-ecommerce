    ...
    <div className="w-full font-body relative">
      ...
      <div className="w-4/5 h-20 m-auto max-[767px]:w-full max-[767px]:pr-5 flex justify-between items-center space-x-11">
        ...
        <div className="flex justify-between items-center space-x-3 ml-0">
          <BsSearch className="cursor-pointer text-xl max-[991px]:hidden hover:scale-125 transition-all" />
        ...
        <div className="flex justify-between max-[991px]:justify-center items-center w-10/12">
          ...
          <h1
            className="font-logo text-4xl  cursor-pointer max-[991px]:translate-x-5
            "
            onClick={() => navigate("/")}
          >
            welly
        ...
        <div className="flex justify-between items-center space-x-3">
          ...
          <BsSearch
            ...
            className="cursor-pointer text-xl max-[991px]:block hover:scale-125 transition-all"
          />
